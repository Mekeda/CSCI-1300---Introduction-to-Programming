"""
Assignment Name: Assignment 7 Ciphers - main.py
...
def main():
	...
	if infile != None:
		...
		if(selection == '1'):
			...
			text = infile.read()
			message = caesar_cipher(text, key)
			for i in range(len(message)):
				print(message[i], end=" ", file=outfile)	
			...
			text = infile.read()
			toEncrypt = True
			message = deranged_cipher(text, keyword, toEncrypt)
